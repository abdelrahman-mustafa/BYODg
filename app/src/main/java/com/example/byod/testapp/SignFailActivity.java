...
public class SignFailActivity extends AppCompatActivity {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (android.os.Build.VERSION.SDK_INT > 22) {
                    ...
                    Intent intent = new Intent(SignFailActivity.this, HomeActivity.class);
                    SignFailActivity.this.startActivity(intent);
                } else {

                    Intent intent = new Intent(SignFailActivity.this, HomeActivity2.class);
                    SignFailActivity.this.startActivity(intent);
                }
        ...
        submit.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        final Dialog dialog = new Dialog(SignFailActivity.this);
                        ...
                        try {
                            jsonString = new JSONObject()
                                    ...
                                    .put("OperationType",String.valueOf(2))
                        ...
                        JsonObjectRequest stringRequest = new JsonObjectRequest(url, ll,
                                new Response.Listener<JSONObject>() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        Log.i("responseOfSubmit", String.valueOf(response));

                                        if (android.os.Build.VERSION.SDK_INT > 22) {

                                            Intent intent = new Intent(SignFailActivity.this, HomeActivity.class);
                                            intent.putExtra("submit","done");
                                            SignFailActivity.this.startActivity(intent);
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(SignFailActivity.this, "Connection Failed", Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        logout.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        SharedPreferences mypreference = PreferenceManager.getDefaultSharedPreferences(SignFailActivity.this);
                        mypreference.edit().putBoolean("loggedIn", false).apply();
                        Intent intent = new Intent(SignFailActivity.this, LoginActivity.class);
                        SignFailActivity.this.startActivity(intent);
                        SignFailActivity.this.finish();
        ...
        support.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(SignFailActivity.this, SupportActivity.class);
                        SignFailActivity.this.startActivity(intent);
        ...
        signIn.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        edi.apply();
                        final Dialog dialog2 = new Dialog(SignFailActivity.this);
